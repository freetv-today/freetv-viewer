export function HelpHowToUse() {
  return (
    <section id="using" className="mb-5">
      ...
      <div className="d-flex flex-row w-100 justify-content-start align-middle gap-3 mb-4">
        <div className="text-center text-secondary">
          <a href="/assets/help/help_freetv_ui_lg.png" target="_blank" className="text-decoration-none" title="Click to see full-sized version of Large Screen interface"><img src="/assets/help/help_freetv_ui_lg.png" className="img-fluid border border-2 border-dark" alt="Large Screen User Interface" /></a><br/>Large Screen     
        </div>
        <div className="text-center text-secondary">
          <a href="/assets/help/help_freetv_ui_sm.png" target="_blank" className="text-decoration-none" title="Click to see full-sized version of Small Screen interface"><img src="/assets/help/help_freetv_ui_sm.png" className="img-fluid border border-2 border-dark" alt="Small Screen User Interface" /></a><br/>Small Screen
        </div>
      </div> 
      <h4 className="fs-5 my-4 fw-bold">Watching A Video</h4>
      <ol className="mb-5 fs-5">
      ...
      <div className="d-flex flex-row w-100 justify-content-start align-middle gap-3 mb-4">
        <div className="text-center text-secondary">
          <a href="/assets/help/help_add_favorites.png" target="_blank" className="text-decoration-none" title="Click to see full-sized version of this image"><img src="/assets/help/help_add_favorites.png" className="img-fluid border border-2 border-dark" alt="Add to Favorites" /></a><br/>Add to Favorites Button    
        </div>
        <div className="text-center text-secondary">
          <a href="/assets/help/help_favorites_list.png" target="_blank" className="text-decoration-none" title="Click to see full-sized version of this image"><img src="/assets/help/help_favorites_list.png" className="img-fluid border border-2 border-dark" alt="Favorites List" /></a><br/>Favorites List
        </div>
      </div> 
      ...
      <h4 className="fs-5 my-5 fw-bold">Add To Favorites While Watching A Show</h4> 
      <p>While you are watching a show, you will see a heart icon with a plus sign in the navigation bar in the top right of the screen. If you click this button, it will add the current show you are watching to your Favorites:</p>
      <p><img src="/assets/help/help_add_favorites_toolbar.png" width="720" className="m-3" title="Add to Favorites navigation bar" alt="Add to Favorites" /></p>
      <p>After a show has been added to your Favorites, the icon will appear highlighted (see below). To remove the show from your Favorites, just click on the icon again and it will change back to the unhighlighted state indicating that it's no longer a part of your Favorites:</p>
      <p><img src="/assets/help/help_add_favorites_highlighted.png" width="145" className="m-3" title="Remove from Favorites" alt="Remove from Favorites" /> Show Has Been Added to Favorites</p>
      ...
      <p>(Click an image to see a larger view in a new tab or window)</p>
      <div className="d-flex flex-row w-100 justify-content-center align-middle gap-3">
          <div className="text-center text-secondary">
            <a href="/assets/help/help_video_ui_lg.png" target="_blank" className="text-decoration-none" title="Click to see full-sized version of large screen Video Player interface"><img src="/assets/help/help_video_ui_lg.png" className="img-fluid border border-2 border-dark" /></a><br/>Large Screen     
          </div>
          <div className="text-center text-secondary">
            <a href="/assets/help/help_video_ui_sm.png" target="_blank" className="text-decoration-none" title="Click to see full-sized version of small screen Video Player interface"><img src="/assets/help/help_video_ui_sm.png" className="img-fluid border border-2 border-dark" /></a><br/>Small Screen
          </div>
      </div>
      <ol className="my-5 fs-5">
        ...
        <li><p>Click the fullscreen icon (or double-click/tap on a playing video) to expand to full screen</p></li>
      </ol>    
      <h4 className="fs-5 mt-5 mb-3 fw-bold">Episode Playlist Navigator</h4> 
      <p className="mb-4">On larger screens, the Internet Archive breaks Episode Playlists into smaller "chunks" (or "cards") and only displays a few episodes at a time. This makes it easier to navigate a large Episode Playlist which contains a lot of videos. Only a small group of titles will be displayed in the Episode Playlist at a time (see the image below). There are dots (or circles) which represent all of the groups of episodes in that playlist. The current group that you are viewing is highlighted with a white dot. You can use the left and right arrows on either side of the dots to navigate forward and backward through the groups of show titles. You can also click on the dots to jump directly to the group of episodes that you want to see.</p>
      <p><a href="/assets/help/help_playlist_card_nav-lg.png" target="_blank" className="text-decoration-none" title="Click to see full-sized version of the Episode Playlist navigator on large screens"><img src="/assets/help/help_playlist_card_nav-lg.png" className="img-fluid border border-2 border-dark" alt="Episode Playlist navigator on large screens"/></a></p>
      <p className="my-4">On smaller screens, this Episode Playlist navigator does not appear. All of the episodes available will appear in a (sometimes lengthy) scroll list. You can scroll up and down to select the video episode that you want to watch:</p>
      <p><a href="/assets/help/help_playlist_card_nav-lg.png" target="_blank" className="text-decoration-none" title="Click to see full-sized version of the Episode Playlist scroll list on small screens"><img src="/assets/help/help_playlist_card_nav-sm.png" className="img-fluid border border-2 border-dark" alt="Episode Playlist scroll list on small screens" /></a></p>
      <h4 className="fs-5 mt-5 mb-3 fw-bold">Additional Video Player Options</h4>   
      <ul className="mb-5 fs-5">
        <li>
          <p className="fs-5 fw-bold py-3">Navigating between videos in the Episode Playlist:</p>
          <p><img src="/assets/help/help_episode-playlist-nav.png" className="img-fluid"/></p>
        </li>
        <li>
          <p className="fs-5 fw-bold py-3">Full Screen mode:</p>
          <p><img src="/assets/help/help_fullscreen.png" className="img-fluid"/></p>
        ...
        <li>
          <p className="fs-5 fw-bold py-3">Picture In Picture (PiP) mode:</p>
          <p><img src="/assets/help/help_pip.png" className="img-fluid"/></p>
          ...
          <p><img src="/assets/help/help_pip_rightclick.png" className="img-fluid"/></p>
        </li>
        <li>
          <p className="fs-5 fw-bold py-3">Screen casting:</p>
          <p><img src="/assets/help/help_casting.png" className="img-fluid"/></p>
        ...
        <li>
          <p className="fs-5 fw-bold py-3">Rewind 10 Seconds:</p>
          <p><img src="/assets/help/help_rewind.png" className="img-fluid"/></p>
          <p>If you hover your cursor over the video while it's playing, it should reveal a "Rewind 10 Seconds" icon (see below). You can click this to jump back 10 seconds and replay anything you missed. Just hover and click one time. Note: this icon only appears when the video is not playing in fullscreen mode. If you are in fullscreen mode, click the icon in the video control toolbar (see above).</p>
          <p><img src="/assets/help/help_rewind_hover.png" className="img-fluid"/></p>
        </li>
        <li>
